...
# --- CONFIGURATION ---
EVAL_FILES = [
    {"name": "Llama", "file": "outputs/prediction_fine_tune_prahok_llama.jsonl"},
    {"name": "Qwen", "file": "outputs/prediction_fine_tune_prahok_qwen2.jsonl"},
    {"name": "Gemma", "file": "outputs/prediction_fine_tune_prahok_gemma.jsonl"}
]
