...
# --- CONFIGURATION ---
EVAL_FILES = [
    {"name": "Llama", "file": "outputs/synthetic_fine_tune_prahok_llama.jsonl"},
    {"name": "Qwen", "file": "outputs/synthetic_fine_tune_prahok_qwen.jsonl"},
    {"name": "Gemma", "file": "outputs/synthetic_fine_tune_prahok_gemma.jsonl"}
]
